...
#consecutivo. En está ocasión, el objeto se llamará 
# "alumnos".
...
#debe salir el mismo número que en código anterior

factorial(N) / (factorial(n) * (factorial(N-n)))

# Mi ejercicio

# 1. Se quieren realizar equipos de 4 integrantes con
# los alumnos de primer y segundo grado de la escuela 
# primaria Emiliano Zapata en Xalapa. En total se tienen
# 120 alumnos.

# N = 120 - Número de elementos

# n = 4 - Grupos de 4 en 4
...
# 3. Nombrar un objeto llamado "combinaciones2", utilizando
# **N**, **n** y **alumnos** y la función **combinations**

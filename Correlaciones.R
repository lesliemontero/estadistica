...
#Para conocer el nombre de las columnas de nuestra
#base de datos, se ocupa:
...
#Se utiliza el siguiente comando para saber la dimensión 
#de la matriz: dim(BD)
...
#1.- Seleccionamos las variables que vayamos a correlacionar, ocupamos:
# str(penguins)
#penguins$especie
...
#2.- Se seleccionan las filas 1 a la 61, que 
#corresponden a la especie Adeli y las variables cuantitativas. 
...
#4.- Generación del grafico de correlación
#plot(adeli)
...
#6.1.- Se genera un nuevo objeto con el nombre de Pearson, es decir
...
# 1.- Exploración de la matriz de datos 

marvel_dc<-read_excel("marvel_dc.xlsx")

#2.-Expploración de la matriz 
...
# rae,minutos, budget y gross.wordwide, con:
#marvel<-marvel_dc[,c(4,6,8,11)]
#*Nota: elegimos columnas nuevas, debido a que la número
# 4 y la6 son caracteres y necesitamos utilizar numéricas
...
#8.- Realizar la corelación de Spearman con:

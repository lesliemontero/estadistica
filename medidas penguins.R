...
#----------------------------------------
#dim(BD) dimensión de la matriz: número de observaciones y variables que contiene la matriz 
dim(penguins)
#str(BD) tipo de variables
str(penguins)
#colnames(BD) nombre de las columnas 
colnames(penguins)
#anyNA(BD) busca de datos perdidos 
anyNA(penguins)
